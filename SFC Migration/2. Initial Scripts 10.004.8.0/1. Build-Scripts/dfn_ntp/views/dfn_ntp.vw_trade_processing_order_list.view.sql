CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_trade_processing_order_list
(
    t01_cl_ord_id,
    t01_ord_no,
    t01_side,
...
AS
    SELECT t01_cl_ord_id,
           ...
           v01_description_lang,
           CASE
               WHEN t01_instrument_type_code = 'BN' THEN t01_cum_quantity
           END
               AS cum_nominal,
           t01_cum_exchange_tax + t01_cum_broker_tax AS cum_tax,
           t01_cum_ord_value - cum_broker_commission AS broker_net
      FROM vw_order_list ol, m01_exchanges m01, m02_institute m02
     WHERE     ol.t01_status_id_v30 IN ('2', 'q', 'r')
           AND t01_cum_quantity > 0
           AND ol.t01_institution_id_m02 = m02.m02_id
           AND m02.m02_primary_institute_id_m02 = m01_institute_id_m02
           AND ol.t01_exchange_code_m01 = m01.m01_exchange_code
           AND m01.m01_trade_processing = 1
/
