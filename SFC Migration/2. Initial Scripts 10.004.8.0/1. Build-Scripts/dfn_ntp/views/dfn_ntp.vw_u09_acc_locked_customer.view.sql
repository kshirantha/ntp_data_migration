CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_u09_acc_locked_customer
(
   u09_id,
   u09_customer_id_u01,
   u09_login_name,
   ...
   SELECT a.u09_id,
     ...
     FROM u09_customer_login a
          ...
          LEFT JOIN u17_employee u17_status_changed_by
             ON u17_status_changed_by.u17_id = a.u09_status_changed_by_id_u17
    ...
    WHERE u09_login_status_id_v01 = 2
/