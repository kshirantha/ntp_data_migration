CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_u07_portfolio_value
(
    u07_id,
    customer_id,
    cash_account_id,
...
AS
      SELECT u07.u07_id,
             MAX (u07.u07_customer_id_u01) AS customer_id,
             MAX (u07.u07_cash_account_id_u06) AS cash_account_id,
