CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_order_list
(
    t01_cl_ord_id,
...
AS
    (SELECT t01.t01_cl_ord_id,
            ...
            t01.t01_act_cpp_tax,
            t01.t01_act_dcm_tax,
            t01.t01_cum_act_cma_tax,
            t01.t01_cum_act_cpp_tax,
            t01.t01_cum_act_dcm_tax,
       ...
       FROM vw_t01_order_list_base t01
            ...
            LEFT JOIN u17_employee u17_approve
                ON t01.t01_approved_by_id_u17 = u17_approve.u17_id
            LEFT JOIN u09_customer_login u09
                ON t01.t01_customer_login_id_u09 = u09.u09_id
