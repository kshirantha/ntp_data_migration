CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_t02_cash_txn_log_all
(
    transaction_id,
    t02_create_date,
    t02_txn_time,
...
AS
      SELECT MAX (t02.t02_order_no) AS transaction_id,
             ...
             MAX (m97_statement) AS m97_statement,
             MAX (m97_category) AS m97_category,
             MAX (t02.t02_trade_process_stat_id_v01)
                 AS t02_trade_process_stat_id_v01,
             MAX (t02_exchange_id_m01) AS t02_exchange_id_m01
