CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_m105_exchange_brokers
(
    m105_id,
    m105_broker_code,
    m105_broker_name,
    ...
    SELECT m105.m105_id,
      ...
      FROM m105_other_brokerages m105
           ...
           LEFT JOIN u17_employee u17_modified_by
               ON m105.m105_modified_by_id_u17 = u17_modified_by.u17_id
...
DROP VIEW dfn_ntp.vw_m105_exchange_brokers
/
