CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_m32_ex_market_status_tif
(
    m32_id,
    m32_tif_type_id_v10,
...
AS
    SELECT m32.m32_id,
           ...
           m32.m32_market_status_id_v19,
           m32.m32_market_code_m29,
      ...
      FROM m32_ex_market_status_tif m32
           JOIN v10_tif v10 ON m32.m32_tif_type_id_v10 = v10.v10_id
           JOIN v06_order_type v06 ON m32.m32_order_type_id_v06 = v06.v06_id
           LEFT JOIN v19_market_status v19
               ON v19.v19_id = m32.m32_market_status_id_v19
           JOIN m01_exchanges m01 ON m32.m32_exchange_id_m01 = m01.m01_id
/