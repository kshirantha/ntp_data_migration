CREATE OR REPLACE FORCE VIEW dfn_ntp.vw_customer_margin_product
(
    u23_id,
    u23_customer_id_u01,
    ...
    (SELECT u23_id,
       ...
       FROM u23_customer_margin_product u23
            LEFT JOIN u06_cash_account u06
                ON u23.u23_default_cash_acc_id_u06 = u06.u06_id -- To Fetch Rejected Items on Add
            ...
            JOIN m77_symbol_marginability_grps m77
                ON u23_sym_margin_group_m77 = m77.m77_id
            LEFT JOIN m75_stock_concentration_group m75
                ON u23.u23_stock_concentration_m75 = m75.m75_id
            LEFT JOIN vw_status_list status
                ON u23.u23_status_id_v01 = status.v01_id
