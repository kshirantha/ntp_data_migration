CREATE OR REPLACE FORCE VIEW dfn_ntp.t02_transact_log_cash_arc_all
(
...
AS
    SELECT t02_amnt_in_txn_currency,
     ...
     WHERE     t02_update_type IN (1, 2, 6)
    ...
    SELECT t02_amnt_in_txn_currency,
           ...
           t02_ord_channel_id_v29,
           t02_dealer_id_u17
      FROM dfn_arc.t02_transaction_log a
     WHERE     t02_update_type IN (1, 2, 6)
           AND t02_amnt_in_stl_currency <> 0
           AND t02_txn_code NOT IN ('REVBUY', 'REVSEL')
           AND t02_txn_entry_status = 0
-- AND a.t02_ord_status_v30 NOT IN ('h')
/