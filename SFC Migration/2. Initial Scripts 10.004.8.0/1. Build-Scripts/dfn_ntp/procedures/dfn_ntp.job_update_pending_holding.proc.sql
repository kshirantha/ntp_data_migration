CREATE OR REPLACE PROCEDURE dfn_ntp.job_update_pending_holding
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'UPDATE_PENDING_HOLDING';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'UPDATE_PENDING_HOLDING_SOD Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job UPDATE_PENDING_HOLDING_SOD Will Not Execute');
