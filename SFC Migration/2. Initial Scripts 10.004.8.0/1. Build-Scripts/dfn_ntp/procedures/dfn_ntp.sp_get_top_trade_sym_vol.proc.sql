CREATE OR REPLACE PROCEDURE dfn_ntp.sp_get_top_trade_sym_vol (
...
BEGIN
    ...
    l_qry :=
           'SELECT *
FROM (select *
from (select sum(T02_HOLDING_NET_ADJST) as volume, T02_SYMBOL_CODE_M20 as symbol, T02_SYMBOL_ID_M20
