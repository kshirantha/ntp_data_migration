CREATE OR REPLACE PROCEDURE dfn_ntp.job_enable_transaction_intl
IS
...
BEGIN
    ...
    FROM v07_db_jobs
    WHERE v07_job_name = 'ENABLE_TRANSACTION_INTL';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'ENABLE_TRANSACTION_INTL Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job ENABLE_TRANSACTION_INTL Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! ENABLE_TRANSACTION_INTL Execution Failed -> ENABLE_TRANSACTION_INTL'
            || SUBSTR (SQLERRM, 1, 512));
END;
/