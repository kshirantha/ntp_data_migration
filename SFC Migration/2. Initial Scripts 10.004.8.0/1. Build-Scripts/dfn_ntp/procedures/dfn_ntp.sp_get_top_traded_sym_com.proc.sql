CREATE OR REPLACE PROCEDURE dfn_ntp.sp_get_top_traded_sym_com (
...
BEGIN
    ...
    l_qry :=
           'SELECT *
FROM (select *
from (select sum(T02_BROKER_COMMISSION) as COMMISSION, T02_SYMBOL_CODE_M20 as symbol, T02_SYMBOL_ID_M20
