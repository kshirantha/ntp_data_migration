CREATE OR REPLACE PROCEDURE dfn_ntp.sp_calc_margexpired_od_interst (
        ...
        IN (SELECT u06.u06_id,
            ...
            FROM u06_cash_account u06,
                 ...
                 (SELECT m118_group_id_m117,
                  ...
                  GROUP BY m118_group_id_m117, m118_currency_code_m03) m118
            WHERE     u06.u06_institute_id_m02 = m02.m02_id
                  ...
                  AND u06.u06_margin_enabled = 2 --margin expired
                  AND (  u06.u06_balance
                       + u06.u06_payable_blocked
                       - u06.u06_receivable_amount) < 0
                  AND m97.m97_code = 'ODINT'
