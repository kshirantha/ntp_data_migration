CREATE OR REPLACE PROCEDURE dfn_ntp.job_update_pending_cash_eod
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'UPDATE_PENDING_CASH_EOD';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'UPDATE_PENDING_CASH_EOD Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job UPDATE_PENDING_CASH_EOD Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! UPDATE_PENDING_CASH_EOD Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/