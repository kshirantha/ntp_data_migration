CREATE OR REPLACE PROCEDURE dfn_ntp.sp_coporate_action_distrb (
    ...
    OPEN p_view FOR
        SELECT t41_id,
               ...
               CASE t41.t41_is_notified WHEN 1 THEN 'Yes' ELSE 'No' END
                   AS notified,
               t41_reinvest,
               CASE t41.t41_reinvest WHEN 1 THEN 'Yes' ELSE 'No' END
                   AS reinvest,
               t41_customer_id_u01,
               t41_cash_acc_id_u06,
               ...
               t41_modified_date,
               t41.t41_cust_corp_act_id_m141
          FROM t41_cust_corp_act_distribution t41
               INNER JOIN u01_customer u01
                   ON t41.t41_customer_id_u01 = u01.u01_id
               INNER JOIN vw_status_list v01
                   ON t41.t41_status_id_v01 = v01_id
         ...
         WHERE     t41.t41_cust_corp_act_id_m141 = pm141_id
               AND t41.t41_institute_id_m02 = pinstitution;
END;
/