CREATE OR REPLACE PROCEDURE dfn_ntp.job_enable_cash_transaction
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'ENABLE_CASH_TRANSACTION';
    ...
    THEN
        UPDATE m02_institute
           SET m02_cash_transation_disable = 0;
        ...
        job_sch_update_job_history (
            ...
            1,
            'ENABLE_CASH_TRANSACTION Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job ENABLE_CASH_TRANSACTION Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! ENABLE_CASH_TRANSACTION Execution Failed -> ENABLE_CASH_TRANSACTION'
            || SUBSTR (SQLERRM, 1, 512));
END;
/
/

drop procedure dfn_ntp.job_enable_cash_transaction
/
