CREATE OR REPLACE PROCEDURE dfn_ntp.job_disable_transaction_intl
IS
...
BEGIN
    ...
    FROM v07_db_jobs
    WHERE v07_job_name = 'DISABLE_TRANSACTION_INTL';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'DISABLE_TRANSACTION_INTL Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job DISABLE_TRANSACTION_INTL Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! DISABLE_TRANSACTION_INTL Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/