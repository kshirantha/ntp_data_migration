CREATE OR REPLACE PROCEDURE dfn_ntp.job_margin_trd_notification
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'MARGIN_TRADING_NOTIFICATIONS_EOD';
    ...
    THEN
        sp_margin_expiory_notification;
        ...
        job_sch_update_job_history (
            ...
            1,
            'MARGIN_TRADING_NOTIFICATIONS_EOD Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job MARGIN_TRADING_NOTIFICATIONS_EOD Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! MARGIN_TRADING_NOTIFICATIONS_EOD Execution Failed -> ENABLE_TRANSACTION'
            || SUBSTR (SQLERRM, 1, 512));
END;
/
