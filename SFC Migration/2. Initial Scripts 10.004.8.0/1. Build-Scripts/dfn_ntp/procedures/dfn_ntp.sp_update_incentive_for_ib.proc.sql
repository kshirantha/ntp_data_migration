CREATE OR REPLACE PROCEDURE dfn_ntp.sp_update_incentive_for_ib
IS
    ...
    IS
          SELECT m162.m162_id,
           ...
           WHERE     m162.m162_id = m163.m163_incentive_group_id_m162
                 ...
                 AND m162.m162_group_type_id_v01 = 3                 --IB Type
        ORDER BY m162_id;
BEGIN
        ...
        FOR commission
            IN (  SELECT m21.m21_id,
                    ...
                    FROM t02_transaction_log_order orders
                         ...
                         JOIN m21_introducing_broker m21
                             ON     u01.u01_ib_id_m21 = m21.m21_id
                                AND m21.m21_incentive_group_id_m162 =
                                        structure.m162_id
                                AND m21.m21_institute_id_m02 =
        ...
        LOOP
            ...
            THEN
                SELECT COUNT (*)
                 ...
                 WHERE     t47_staff_or_customer_id = commission.m21_id
