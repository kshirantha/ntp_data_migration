CREATE OR REPLACE PROCEDURE dfn_ntp.job_capitalize_custody_charges
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'CAPITALIZE_CUSTODY_CHARGES';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'CAPITALIZE_CUSTODY_CHARGES Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job CAPITALIZE_CUSTODY_CHARGES Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! CAPITALIZE_CUSTODY_CHARGES Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/
