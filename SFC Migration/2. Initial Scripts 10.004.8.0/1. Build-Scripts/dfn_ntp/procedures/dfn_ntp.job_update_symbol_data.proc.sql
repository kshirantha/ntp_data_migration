CREATE OR REPLACE PROCEDURE dfn_ntp.job_update_symbol_data
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'UPDATE_SYMBOL_DATA';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'UPDATE_SYMBOL_DATA Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job UPDATE_SYMBOL_DATA Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! UPDATE_SYMBOL_DATA Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/
