CREATE OR REPLACE PROCEDURE dfn_ntp.job_capitalz_int_charge_locl_b
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'CAPITALIZE_INT_CHARGES_LOCAL';
    ...
    THEN
        sp_re_calculate_margn_intrst_b (ptype => 0);
        sp_capitalize_margin_interst_b (ptype => 0);
        sp_capitalize_other_interest_b (ptype => 0);
        COMMIT;
        ...
        job_sch_update_job_history (
            ...
            1,
            'CAPITALIZE_INT_CHARGES_LOCAL Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job CAPITALIZE_INT_CHARGES_LOCAL Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! CAPITALIZE_INT_CHARGES_LOCAL Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/
