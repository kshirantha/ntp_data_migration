CREATE OR REPLACE PROCEDURE dfn_ntp.job_update_pending_cash
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'UPDATE_PENDING_CASH';
    ...
    THEN
        ...
        job_sch_update_job_history (
            ...
            1,
            'UPDATE_PENDING_CASH Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job UPDATE_PENDING_CASH Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! UPDATE_PENDING_CASH Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/