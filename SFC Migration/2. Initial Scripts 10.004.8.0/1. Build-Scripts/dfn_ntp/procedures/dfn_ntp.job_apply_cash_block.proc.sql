CREATE OR REPLACE PROCEDURE dfn_ntp.job_apply_cash_block
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'APPLY_CASH_BLOCK';
    ...
    THEN
        ...
        job_sch_update_job_history (l_current_job_id,
                                    ...
                                    1,
                                    'APPLY_CASH_BLOCK Executed Successfully');
    ELSE
        job_sch_update_job_history (
            ...
            || l_dependant_job
            || ' Not Executed! Current Job APPLY_CASH_BLOCK Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! APPLY_CASH_BLOCK Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/

DROP PROCEDURE dfn_ntp.job_apply_cash_block
/
