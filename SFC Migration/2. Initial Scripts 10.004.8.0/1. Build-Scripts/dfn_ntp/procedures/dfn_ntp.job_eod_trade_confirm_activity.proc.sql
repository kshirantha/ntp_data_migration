CREATE OR REPLACE PROCEDURE dfn_ntp.job_eod_trade_confirm_activity
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'EOD_TRADE_CONFIRM_ACTIVITY';
    ...
    THEN
       dfn_ntp.sp_reset_trade_confirmation_no ();
       job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            1,
            'EOD_TRADE_CONFIRM_ACTIVITY Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job EOD_TRADE_CONFIRM_ACTIVITY Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! EOD_TRADE_CONFIRM_ACTIVITY Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
COMMIT;
END;
/