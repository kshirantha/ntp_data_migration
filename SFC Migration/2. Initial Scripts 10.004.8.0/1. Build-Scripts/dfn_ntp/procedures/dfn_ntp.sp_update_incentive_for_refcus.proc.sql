CREATE OR REPLACE PROCEDURE dfn_ntp.sp_update_incentive_for_refcus
IS
    ...
    IS
          SELECT m162.m162_id,
           ...
           WHERE     m162.m162_id = m163.m163_incentive_group_id_m162
                 ...
                 AND m162.m162_group_type_id_v01 = 4           --REF CUST Type
        ORDER BY m162_id;
BEGIN
                    ...
                    FROM t02_transaction_log_order orders
                         ...
                         JOIN u01_customer u01
                             ON     u06.u06_customer_id_u01 = u01.u01_id
                                AND u01.u01_incentive_group_id_m162 =
                                        structure.m162_id
                         LEFT JOIN u06_cash_account ref_cash
                             ON     u01.u01_referral_cash_acc_id_u06 =
                                        ref_cash.u06_id
        ...
        LOOP
            ...
            THEN
                SELECT COUNT (*)
                 ...
                 WHERE     t47_staff_or_customer_id = commission.u06_id
