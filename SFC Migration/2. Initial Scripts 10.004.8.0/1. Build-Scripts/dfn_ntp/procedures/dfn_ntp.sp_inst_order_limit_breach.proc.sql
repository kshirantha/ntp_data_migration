CREATE OR REPLACE PROCEDURE dfn_ntp.sp_inst_order_limit_breach
IS
BEGIN
    FOR i
        IN (SELECT m02.m02_id,
                   m02.m02_name,
                   m02.m02_email,
                   ord_limit.m69_order_value_per_day,
                   ord_limit.m69_order_volume_per_day,
                   ...
                   END
                       AS breached_type
            FROM (SELECT t02.t02_inst_id_m02,
                         NVL (
                             SUM (
                         ...
                         MAX (m69.m69_order_value_per_day)
                             AS m69_order_value_per_day,
                         MAX (m69.m69_order_volume_per_day)
                             AS m69_order_volume_per_day
                    FROM t02_transaction_log_order_all t02,
                         m69_institute_trading_limits m69
                   WHERE     t02.t02_inst_id_m02 = m69.m69_institution_id_m02
                         AND t02.t02_create_date = TRUNC (SYSDATE)
                  GROUP BY t02.t02_inst_id_m02) ord_limit,
                 u41_notification_configuration u41,
                 m02_institute m02
            WHERE     ord_limit.t02_inst_id_m02 = u41.u41_institution_id_m02
                  AND u41.u41_notification_type_id_m100 = 49
                  AND u41.u41_institution_id_m02 = m02.m02_id
