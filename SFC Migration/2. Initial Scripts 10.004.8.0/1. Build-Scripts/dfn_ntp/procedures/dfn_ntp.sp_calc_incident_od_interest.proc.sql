CREATE OR REPLACE PROCEDURE dfn_ntp.sp_calc_incident_od_interest (
...
BEGIN
    FOR i
        IN (SELECT u06.u06_id,
                   m02.m02_id,
                   NVL (u06.u06_incident_overdrawn_amt, 0) incident_od_amount,
                   NVL (m118_interest_rate,
                        NVL (m02.m02_overdrawn_interest_rate, 0))
                       interest_rate,
                   ROUND (
                       ABS (
                             NVL (u06.u06_incident_overdrawn_amt, 0)
                           * NVL (m118_interest_rate,
                                  NVL (m02.m02_overdrawn_interest_rate, 0))
                           / 36000),
                       2)
            ...
            FROM u06_cash_account u06,
                 ...
                 (SELECT m118_group_id_m117,
                   ...
                   WHERE m118_charge_code_m97 = 'IODINT'
            ...
            WHERE     u06.u06_institute_id_m02 = m02.m02_id
                  ...
                  AND NVL (u06.u06_incident_overdrawn_amt, 0) < 0
                  AND m97.m97_code = 'IODINT'
    ...
    LOOP
        ...
        THEN
            ...
            VALUES (fn_get_next_sequnce ('T21_DAILY_INTEREST_FOR_CHARGES'),
                    ...
                    NULL,
                    i.m02_id,
                    --i.interest_rate, -- t21_interest_indices_rate_m65
                    i.tax_amount,
                    i.m118_broker_vat);
        END IF;
    END LOOP;
