CREATE OR REPLACE PROCEDURE dfn_ntp.job_margin_fund_cover_intl_b
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'MARGIN_FUNDING_COVERING_INTL';
    ...
    THEN
        dfn_ntp.sp_margin_funding_covering_b (ptype => 1);
        COMMIT;
        ...
        job_sch_update_job_history (
            ...
            1,
            'MARGIN_FUNDING_COVERING_INTL Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job MARGIN_FUNDING_COVERING_INTL Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! MARGIN_FUNDING_COVERING_INTL Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
