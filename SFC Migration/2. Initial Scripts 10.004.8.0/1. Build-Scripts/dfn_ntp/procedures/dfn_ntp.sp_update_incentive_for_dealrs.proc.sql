CREATE OR REPLACE PROCEDURE dfn_ntp.sp_update_incentive_for_dealrs
IS
    ...
    IS
          SELECT m162.m162_id,
           ...
           WHERE     m162.m162_id = m163.m163_incentive_group_id_m162
                 ...
                 AND m162.m162_group_type_id_v01 = 2             --Dealer Type
        ORDER BY m162_id;
BEGIN
    ...
    LOOP
        FOR commission
            IN (  SELECT t01_dealer_id_u17 AS dealer_id,
                         m01.m01_id,
                         m01_exchange_code,
                   ...
                   WHERE     (   (    structure.m162_frequency_id_v01 = 2
                              ...
                              OR (    structure.m162_frequency_id_v01 = 3
                                  ...
                                  --AND t01.t01_date >= iso_week_start_date - 30
                              ...
                              OR (    structure.m162_frequency_id_v01 = 5
                                  ...
                                  AND t01.t01_date >= start_of_the_month - 30
                                  AND l_sysdate = TRUNC (end_of_the_month)
                                  AND orders.t02_cash_settle_date BETWEEN start_of_the_month
                                                                      AND end_of_the_month))
                         AND orders.t02_cliordid_t01 = t01.t01_cl_ord_id
                         AND orders.t02_exchange_id_m01 = m01.m01_id
                         AND t01.t01_dealer_id_u17 = u17.u17_id
                         AND u17.u17_dealer_cmsn_grp_id_m162 =
                                 structure.m162_id
                         AND u17.u17_institution_id_m02 =
                ...
                GROUP BY t01.t01_dealer_id_u17,
                         m01.m01_id,
                         m01_exchange_code,
                         orders.t02_txn_currency)
        LOOP
            ...
            THEN
                SELECT COUNT (*)
                 ...
                 WHERE     t47_staff_or_customer_id = commission.dealer_id
                ...
                THEN
                    DELETE t47_incentive_for_staff_n_cust
                     WHERE     t47_staff_or_customer_id =
                                   commission.dealer_id
                           AND t47_exchange_id_m01 = commission.m01_id
                           AND t47_txn_currency_code_m03 =
                                   commission.t02_txn_currency
                           AND t47_group_type_id_v01 =
