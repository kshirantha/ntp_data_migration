CREATE OR REPLACE PROCEDURE dfn_ntp.job_derivative_symbol_expiry
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'DERIVATIVE_SYMBOL_EXPIRY';
    ...
    THEN
        sp_derivative_symbol_expiry ();

        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            1,
            'DERIVATIVE_SYMBOL_EXPIRY Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job DERIVATIVE_SYMBOL_EXPIRY Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! DERIVATIVE_SYMBOL_EXPIRY Execution Failed -> ENABLE_TRANSACTION'
            || SUBSTR (SQLERRM, 1, 512));
END;
/