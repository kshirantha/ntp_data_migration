CREATE OR REPLACE PROCEDURE dfn_ntp.job_capitalz_int_charge_intl_b
IS
...
BEGIN
    SELECT v07_id
      ...
      FROM v07_db_jobs
     WHERE v07_job_name = 'CAPITALIZE_INT_CHARGES_INTL';
    ...
    THEN
        sp_re_calculate_margn_intrst_b (ptype => 1);
        sp_capitalize_margin_interst_b (ptype => 1);
        sp_capitalize_other_interest_b (ptype => 1);
        COMMIT;
        ...
        job_sch_update_job_history (
            ...
            1,
            'CAPITALIZE_INT_CHARGES_INTL Executed Successfully');
    ELSE
        job_sch_update_job_history (
            l_current_job_id,
            l_current_job_log_id,
            ...
            || l_dependant_job
            || ' Not Executed! Current Job CAPITALIZE_INT_CHARGES_INTL Will Not Execute');
...
EXCEPTION
    ...
    THEN
        ...
        job_sch_send_notification (
               'ERROR!!! CAPITALIZE_INT_CHARGES_INTL Execution Failed -> '
            || SUBSTR (SQLERRM, 1, 512));
END;
/
