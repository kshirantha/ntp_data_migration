CREATE OR REPLACE PROCEDURE dfn_ntp.sp_get_t78_settled_transaction (
...
BEGIN
   ...
   l_qry :=
         'SELECT a.t02_order_no,
          ...
          FROM t02_transaction_log a
               JOIN m26_executing_broker m26
                   ON a.t02_custodian_id_m26 = m26.m26_id
      ...
      || TO_CHAR (psettledate, ' DD - MM - YYYY ')
      || ''', '' DD - MM - YYYY '') + .99999
       AND t02_last_db_seq_id IN
                       (SELECT t82.t82_t02_last_db_seq_id
                        FROM t82_custodian_settlements_log t82
                        WHERE t82.t82_id_t78 =  '
      || pt78id
      || ')';
