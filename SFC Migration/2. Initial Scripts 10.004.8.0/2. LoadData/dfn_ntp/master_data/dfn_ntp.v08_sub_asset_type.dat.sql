...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"V08_ID" NUMBER(2,0), 
	"V08_CODE" VARCHAR2(50), 
	"V08_DESCRIPTION" VARCHAR2(150), 
	"V08_DESCRIPTION_LANG" VARCHAR2(150)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.v08_sub_asset_type.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.v08_sub_asset_type select * from e_tmp;
