...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M100_ID" NUMBER(5,0), 
	...
	"M100_DESCRIPTION" VARCHAR2(75), 
	"M100_ITEM_TYPE" NUMBER(1,0)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.m100_notification_sub_items.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.m100_notification_sub_items select * from e_tmp;
