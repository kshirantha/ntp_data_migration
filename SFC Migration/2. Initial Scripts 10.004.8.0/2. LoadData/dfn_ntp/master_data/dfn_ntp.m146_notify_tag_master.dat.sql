...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M146_ID" NUMBER(5,0) , 
	"M146_TAG" VARCHAR2(20) , 
	"M146_DESCRIPTION" VARCHAR2(100) , 
	"M146_DESCRIPTION_LANG" VARCHAR2(100)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.m146_notify_tag_master.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.m146_notify_tag_master select * from e_tmp;
