...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"V36_ID" NUMBER(10,0) , 
	...
	"V36_EQUATION_ID_V01" NUMBER(5,0) , 
	"V36_IS_VISIBLE" NUMBER(1,0) 
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.v36_margin_product_equation.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.v36_margin_product_equation select * from e_tmp;
