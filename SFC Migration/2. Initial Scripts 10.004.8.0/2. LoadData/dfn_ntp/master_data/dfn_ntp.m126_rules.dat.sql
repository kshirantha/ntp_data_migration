...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M126_RULE_TYPE_ID" NUMBER(3,0), 
	"M126_RULE_KEY" VARCHAR2(100), 
	"M126_RULE" VARCHAR2(2000), 
	"M126_PASSED_MSG" VARCHAR2(200), 
	"M126_FAILED_MSG" VARCHAR2(200), 
	"M126_PRIMARY_INSTITUTE_ID" NUMBER(3,0)
   ) 
...
begin
  insert into dfn_ntp.m126_rules select * from e_tmp;
