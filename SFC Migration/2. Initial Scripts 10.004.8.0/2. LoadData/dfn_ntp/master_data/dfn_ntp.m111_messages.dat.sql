...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M111_MESSAGE_ID" VARCHAR2(10), 
	"M111_MESSAGE" VARCHAR2(4000), 
	"M111_MESSAGE_LANG" VARCHAR2(4000), 
	"M111_MSG_TYPE" NUMBER(5,0)
   ) 
...
begin
  insert into dfn_ntp.m111_messages select * from e_tmp;
