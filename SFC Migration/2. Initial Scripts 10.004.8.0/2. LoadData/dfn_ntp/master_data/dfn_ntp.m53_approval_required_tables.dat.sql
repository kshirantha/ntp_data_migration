...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M53_ID" NUMBER(5,0), 
	"M53_TABLE" VARCHAR2(50), 
	"M53_TABLE_DESCRIPTION" VARCHAR2(50), 
	...
	"M53_CUSTOM_TYPE" VARCHAR2(50), 
	"M53_ROUTE" VARCHAR2(1000)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.m53_approval_required_tables.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.m53_approval_required_tables select * from e_tmp;
