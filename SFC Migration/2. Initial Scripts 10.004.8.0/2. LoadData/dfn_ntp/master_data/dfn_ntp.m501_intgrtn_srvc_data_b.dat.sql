...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M501_ID" NUMBER(5,0) , 
	"M501_KEY" VARCHAR2(50) , 
	"M501_VALUE" VARCHAR2(1000), 
	"M501_TYPE" NUMBER(2,0), 
	"M501_TYPE_DESCRIPTION" VARCHAR2(255)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.m501_intgrtn_srvc_data_b.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.m501_intgrtn_srvc_data_b select * from e_tmp;
