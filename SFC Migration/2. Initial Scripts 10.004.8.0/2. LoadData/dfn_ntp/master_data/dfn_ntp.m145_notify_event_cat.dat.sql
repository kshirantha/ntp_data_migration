...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"M145_ID" NUMBER(5,0) , 
	"M145_DESCRIPTION" VARCHAR2(100) , 
	"M145_DESCRIPTION_LANG" VARCHAR2(100)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.m145_notify_event_cat.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.m145_notify_event_cat select * from e_tmp;
