...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"V32_CODE" VARCHAR2(50), 
	"V32_TEXT" VARCHAR2(2000), 
	"V32_TEXT_LANG" VARCHAR2(2000)
   ) 
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.v32_language_dictionary.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.v32_language_dictionary select * from e_tmp;
