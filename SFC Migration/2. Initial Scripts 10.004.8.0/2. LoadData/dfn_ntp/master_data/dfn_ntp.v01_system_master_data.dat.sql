...
/
  ...
  CREATE TABLE "E_TMP" 
   (	"V01_ID" NUMBER(5,0) , 
	"V01_DESCRIPTION" VARCHAR2(255), 
	"V01_DESCRIPTION_LANG" VARCHAR2(255), 
	"V01_TYPE" NUMBER(10,0), 
	"V01_TYPE_DESCRIPTION" VARCHAR2(255), 
   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_DATAPUMP
      ...
      ( version '11.2'    )
      LOCATION
       ( 'dfn_ntp.v01_system_master_data.dat'
       )
    )
/
...
begin
  insert into dfn_ntp.v01_system_master_data select * from e_tmp;
